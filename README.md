...
[Here](https://github.com/dcordero/Travis-Issue-7361/blame/master/README.md#L804) you can see that `fastlane --version` shows `fastlane 1.111.0` even though it was updated [here](https://github.com/dcordero/Travis-Issue-7361/blame/master/README.md#L785)
